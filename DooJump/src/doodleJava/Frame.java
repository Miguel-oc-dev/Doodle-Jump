...
public class Frame extends JFrame {
    ...
    public void start() {
        JOptionPane.showOptionDialog(null, "Listo...?",
                "Inicia!!", JOptionPane.OK_OPTION, JOptionPane.WARNING_MESSAGE, null, new String[]{"GO!"}, 0);
    ...
    private void setTitle(int points) {
        this.setTitle("Doodle UwU - " + points + " points");
    }
